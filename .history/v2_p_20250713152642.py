...
if uploaded_file:
    ...
    folder_path = os.path.join("/Users/simrannaik/Desktop/solution_improvement/ds-prototypes/subjective_grading/solution_improvement/OCR_gd_gem/gemini_2.5_pro_768/Biology", folder_name)
