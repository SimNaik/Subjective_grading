...
def main():
    ...
    if uploaded_file is not None:
        ...
        user_input = st.text_area("Enter your prompt:", 
                                  """Return bounding boxes as JSON arrays on the line "10. a) Pole: The centre of a spherical mirror is called the pole. It lies in front of a concave mirror." [ymin, xmin, ymax, xmax]""")
