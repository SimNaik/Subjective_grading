...
for root, dirs, files in os.walk(INPUT_DIR):
    for file in files:
        ...
        rel_path = os.path.relpath(input_md_path, INPUT_DIR)
        output_md_dir = os.path.join(OUTPUT_DIR, os.path.dirname(rel_path))
        os.makedirs(output_md_dir, exist_ok=True)
        output_md_path = os.path.join(output_md_dir, file)
