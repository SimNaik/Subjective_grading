...
# === Prompt for Gemini ===
PROMPT = """
Return bounding boxes as JSON arrays on the word "Biology"
[ymin, xmin, ymax, xmax] 
"""
...
def send_to_gemini(pil_image):
    try:
        ...
        # Use the new Gemini SDK helper (no need for Part)
        image_part = genai.upload_image(
            image_bytes=img_bytes,
            mime_type="image/jpeg"
        )

        # Call Gemini with prompt and image
