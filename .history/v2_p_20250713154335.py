...
# === Folder Path Input for JSON Output ===
json_folder_path = st.text_input("Enter output folder path for saving JSON:", value=folder_path)
json_path = os.path.join(json_folder_path, "output.json") if json_folder_path else ""
