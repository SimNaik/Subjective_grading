...
selected_model_1 = st.selectbox("Select Model 1", model_options)

# Dropdown to select Model 2
selected_model_2 = st.selectbox("Select Model 2", model_options)
...
if uploaded_file:
    ...
    if images:
        try:
            ...
            # Initialize Model 1 dynamically
    ...
    if images:
        try:
            ...
            # Initialize Model 2 dynamically
...
with col2:
    ...
    model_1_btn = st.button(f"Show {model_1_name} JSON")
    model_2_btn = st.button(f"Show {model_2_name} JSON")
